...
# discounts: -33% & -50% if almost past exp.date -35%  (exp discount can go on top of regular discount!)
...
# rapports:
# hourly: how much produce left, how much is almost* exp.date, how  much is exp.date, how much money made.
